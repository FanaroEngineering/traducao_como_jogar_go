...
\begin{itemize}
    ...
    \begin{figure}[h]
        \includegraphics[width=0.3\textwidth]{Dia 1-3_1}
        \caption{\emph{Dia. 1}}
        \centering
    \end{figure}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{.3\textwidth}
            \centering
            \includegraphics[width=.9\textwidth]{Dia 1-3_1}
            \caption{\emph{Dia. 1}}
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \centering
            \includegraphics[width=.9\textwidth]{Dia 1-3_2}
            \caption{\emph{Dia. 2}}
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \centering
            \includegraphics[width=.9\textwidth]{Dia 1-3_3}
            \caption{\emph{Dia. 3}}
        \end{subfigure}
    \end{figure}
