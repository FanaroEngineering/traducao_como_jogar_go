...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.6\textwidth]{2 - Dia 19}
        \caption*{\emph{Dia.\@~19. Atari}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.6\textwidth]{2 - Dia 20}
        \caption*{\emph{Dia.\@~20. Branco 1: ilegal}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.6\textwidth]{2 - Dia 21}
...
\begin{SCfigure}[][!h]
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 1 - Dia 1}
        \caption*{\emph{Dia.\@~1. Correto}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 1 - Dia 2}
        \caption*{\emph{Dia.\@~2. Errado}}
    \end{subfigure}
    \hfill
    \caption*{\textbf{Resposta ao\\Problema 1}\\\vspace*{.25cm}Preto 1 no \emph{Dia.\@~1} captura um pedra.\\\vspace*{.25cm}Se Preto joga 1 no \emph{Dia.\@~2}, Branco pode resgatar sua pedra através da extensão de 2.}
\end{SCfigure}
...
\begin{SCfigure}[][h!]
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 2 - Dia 1}
        \caption*{\emph{Dia.\@~1. Correto}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 2 - Dia 2}
        \caption*{\emph{Dia.\@~2. Errado}}
    \end{subfigure}
    \hfill
...
\begin{SCfigure}[][h!]
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 3 - Dia 1}
        \caption*{\emph{Dia.\@~1. Correto}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.31\textwidth}
        \includegraphics[width=.9\textwidth]{2 - Problema 3 - Dia 2}
        \caption*{\emph{Dia.\@~2. Errado}}
    \end{subfigure}
    \hfill
...
\begin{SCfigure}[][h!]
    ...
    \end{subfigure}
    \hfill
    \caption*{\textbf{Resposta ao\\Problema 21}\\\vspace*{.25cm}Preto 1 no \emph{1} resgata suas duas pedras em atari.\\\vspace*{.25cm}Se Preto faz atari com 1 no \emph{Dia.\@~2}, Branco captura duas pedras com 2.}
\end{SCfigure}
...
\begin{SCfigure}[][h!]
    ...
    \end{subfigure}
    \hfill
    \caption*{\textbf{Resposta ao\\Problema 25}\\\vspace*{.25cm}Se Preto faz atari em 1 no \emph{Dia.\@~1}, ele captura quatro pedras. Se Branco joga 2, ele não possuirá nenhuma maneira de escapar depois de Preto 3.\\\vspace*{.25cm}Se Preto faz atari com 1 no \emph{Dia.\@~2}, Branco estende com 2 e suas pedras escapam.}
\end{SCfigure}
