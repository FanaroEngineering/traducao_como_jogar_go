...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 28}
      \caption*{\emph{Dia.\@~28. Uma jogada ilegal}}
  \end{subfigure}
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 29}
      \caption*{\emph{Dia.\@~29. Mesma posição}}
  \end{subfigure}
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 30}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 32}
      \caption*{\emph{Dia.\@~32. Uma ameaça de ko}}
  \end{subfigure}
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 33}
      \caption*{\emph{Dia.\@~33. Branco captura}}
  \end{subfigure}
  \begin{subfigure}[t]{.3\textwidth}
      \centering
      \includegraphics[width=.9\textwidth]{3 - Dia 34}
